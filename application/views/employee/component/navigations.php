                        ...
                        <nav class="main-menu navbar navbar-collapse menu-bg" role="navigation">
                            ...
                            <div class="main-menu collapse navbar-collapse menu-bg" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="<?php if(!empty($menu['manage_attendance'])){ echo $menu['manage_attendance'] == 1 ? 'active' : '';} ?>"><a href="<?php echo base_url() ?>employee/attendance/manage_attendance">Attendance</a></li>
