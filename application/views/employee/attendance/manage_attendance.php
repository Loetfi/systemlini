...
<div class="row">
    ...
    <?php  $id = $this->session->userdata('employee_id'); 

       $detail =  $this->db->query("
                                    SELECT a.employee_id,c.department_name , c.department_id FROM tbl_employee a
                                    INNER JOIN tbl_designations b ON a.designations_id = b.designations_id
                                    INNER JOIN tbl_department c ON b.department_id = c.department_id
                                    WHERE a.employee_id = '$id'")->row();
    ?>
                ...
                <div class="wrap-fpanel">
                    <div class="panel panel-default" data-collapsed="0">                    
                        ...
                        <div class="panel-body">
                            <form id="form" action="<?php echo base_url() ?>employee/attendance/manage_attendance" method="post"  enctype="multipart/form-data" class="form-horizontal">   
                                <div class="panel_controls">                         
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-5">
                                        <input type="hidden" value="<?php echo $detail->department_id; ?>" name="department_id">
                    ...
                    <?php if (!empty($employee_info)): ?>
                        <form action="<?php echo base_url() ?>employee/attendance/save_attendance" method="post"  enctype="multipart/form-data" class="form-horizontal">   
