                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <?php if (!empty($emp_salary_info->house_rent_allowance)): ?>
                            <div class="">
                                <label class="col-sm-6 control-label" ><strong>Meal Allowance  : </strong></label>
                                <p class="form-control-static"><?php
                                    if (!empty($genaral_info[0]->currency)) {
                                        $currency = $genaral_info[0]->currency;
                                    } else {
                        ...
                        <?php if (!empty($emp_salary_info->special_allowance)): ?>
                            <div class="">
                                <label class="col-sm-6 control-label" ><strong>Transport Allowance  : </strong></label>
                                <p class="form-control-static"><?php
                                    if (!empty($genaral_info[0]->currency)) {
                                        $currency = $genaral_info[0]->currency;
                                    } else {
                        ...
                        <?php if (!empty($emp_salary_info->fuel_allowance)): ?>
                            <div class="">
                                <label class="col-sm-6 control-label" ><strong>BPJS Kesehatan Allowance  : </strong></label>
                                <p class="form-control-static"><?php
                                    if (!empty($genaral_info[0]->currency)) {
                                        $currency = $genaral_info[0]->currency;
                                    } else {
                        ...
                        <?php if (!empty($emp_salary_info->other_allowance)): ?>
                            <div class="">
                                <label class="col-sm-6 control-label" ><strong>BPJS Ketenegakerjaan Allowance  : </strong></label>
                                <p class="form-control-static"><?php
                                    if (!empty($genaral_info[0]->currency)) {
                                        $currency = $genaral_info[0]->currency;
                                    } else {
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php if (!empty($emp_salary_info->provident_fund)): ?>
                            <div class="">
                                <label class="col-sm-6 control-label" ><strong>BPJS Kesehatan  : </strong></label>
                                <p class="form-control-static"><?php
                                    if (!empty($genaral_info[0]->currency)) {
                                        $currency = $genaral_info[0]->currency;
                                    } else {
                        ...
                        <?php if (!empty($emp_salary_info->other_deduction)): ?>
                            <div class="">
                                <label class="col-sm-6 control-label" ><strong>BPJS Ketenegakerjaan  : </strong></label>
                                <p class="form-control-static"><?php
                                    if (!empty($genaral_info[0]->currency)) {
                                        $currency = $genaral_info[0]->currency;
                                    } else {
