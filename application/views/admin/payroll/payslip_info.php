    ...
    <div id="payment_receipt">
                ...
                <tr>
                    ...
                    if (!empty($genaral_info)) {
                        foreach ($genaral_info as $info) {
                            ...
                            <td style="border: 0px;">
                                <p style="margin-left: 10px; font: 20px lighter;"><?php echo $info->name ?></p>
                                <p style="margin-left: 10px; font: 10px lighter;"><?php echo $info->address ?></p>
                            </td>
                            <?php
                        }
                    } else {
        ...
        <div style="width: 100%;">            
            <div align="center">
                <table class="head">
                    <tr>
                        <td colspan="3" style="text-align: center; font-size: 18px; padding-bottom: 30px;"><strong>Payslip <br/>Salary Month: <?php echo date('F , Y', strtotime($employee_salary_info->payment_for_month)) ?></strong> </td>
                    </tr>
                    <tr>
            ...
            <div align="center">
                <div class="tbl1">
                    <table>
                        ...
                        <?php if (!empty($employee_salary_info->house_rent_allowance)): ?>
                            <tr>
                                <td style="text-align: left"><strong>Meal  :&nbsp;&nbsp;</strong></td>
                        ...
                        <?php if (!empty($employee_salary_info->medical_allowance)): ?>
                            <tr>
                                <td style="text-align: left"><strong>Medical  :&nbsp;&nbsp;</strong></td>
                        ...
                        <?php if (!empty($employee_salary_info->phone_bill_allowance)): ?>
                            <tr>
                                <td style="text-align: left"><strong>Phone Bill  Allowance  :&nbsp;&nbsp;</strong></td>
                        ...
                        <?php if (!empty($employee_salary_info->fuel_allowance)): ?>
                            <tr>
                                <td style="text-align: left"><strong>BPJS Kesehatan  :&nbsp;&nbsp;</strong></td>
                        ...
                        <?php if (!empty($employee_salary_info->other_allowance)): ?>
                            <tr>
                                <td style="text-align: left"><strong>BPJS Ketenegakerjaan  :&nbsp;&nbsp;</strong></td>
                ...
                <div class="tbl2">
                    <table>
                        ...
                        <?php if (!empty($employee_salary_info->other_deduction)): ?>
                            <tr>
                                <td style="text-align: left"><strong>BPJS Ketenagakerjaan  :&nbsp;&nbsp;</strong></td>
                ...
                <table class="tbl_total">
                    ...
                    <?php if (!empty($employee_salary_info)): ?>
                        <tr>
                            <td style="text-align: left;"><strong> Gross Salary   :&nbsp;&nbsp;</strong></td>
                            <td>&nbsp; <?php
                                if (!empty($genaral_info[0]->currency)) {
                                    $currency = $genaral_info[0]->currency;
                                } else {
                    ...
                    <?php if (!empty($employee_salary_info)): ?>
                        <tr>
                            <td style="text-align: left"><strong>Total Deduction  :&nbsp;&nbsp;</strong></td>
                    ...
                    <?php if (!empty($employee_salary_info)): ?>
                        <tr>
                            <td style="text-align: left"><strong>Net Salary  :&nbsp;&nbsp;</strong></td>
                    ...
                    <?php if (!empty($employee_salary_info->fine_deduction)): ?>
                        <tr>
                            <td style="text-align: left"><strong>Fine Deduction  :&nbsp;&nbsp;</strong></td>
