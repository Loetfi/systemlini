            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <div class="">
                        ...
                        <textarea id="present" name="address" class="form-control" ><?php
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <div class="">
                        ...
                        if (!empty($employee_info->elementary_school)) {
                            echo $employee_info->elementary_school;
                        }                        
                        ?>" class="form-control" >
                        <input type="hidden" name="employee_education_id" value="<?php
                        if (!empty($employee_info->employee_education_id)) {
                            echo $employee_info->employee_education_id;
                        }
                        ?>" class="form-control" >
                    </div>
                    <div class="">
                        ...
                        if (!empty($employee_info->junior_high_school)) {
                            echo $employee_info->junior_high_school;
                        }
                        ?>" class="form-control" >
                    </div>
                    <div class="">
                        ...
                        if (!empty($employee_info->high_school)) {
                            echo $employee_info->high_school;
                        }
                        ?>" class="form-control">
                    </div>
                    <div class="">
                        ...
                        if (!empty($employee_info->diplome)) {
                            echo $employee_info->diplome;
                        }
                        ?>" class="form-control">
                    </div>
                    <div class="">
                        ...
                        if (!empty($employee_info->university)) {
                            echo $employee_info->university;
                        }
                        ?>" class="form-control">
                    </div>
                </div>
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <div class="">
                        ...
                        if (!empty($employee_info->spouse_name)) {
                            echo $employee_info->spouse_name;
                        }                        
                        ?>" class="form-control" >
                        <input type="hidden" name="employee_family_id" value="<?php
                        if (!empty($employee_info->employee_family_id)) {
                            echo $employee_info->employee_family_id;
                        }
                        ?>" class="form-control" >
                    </div>
                    <div class="">
                        ...
                        if (!empty($employee_info->child_name)) {
                            echo $employee_info->child_name;
                        }
                        ?>" class="form-control" >
                    </div>
                    <div class="">
                        ...
                        if (!empty($employee_info->child2_name)) {
                            echo $employee_info->child2_name;
                        }
                        ?>" class="form-control">
                    </div>
                    <div class="">
                    ...
                    <div class="">
                        ...
                        if (!empty($employee_info->own_brosis_name)) {
                            echo $employee_info->own_brosis_name;
                        }
                        ?>" class="form-control">
                    </div>
                    <div class="">
                        ...
                        if (!empty($employee_info->own_brosis_name1)) {
                            echo $employee_info->own_brosis_name1;
                        }
                        ?>" class="form-control">
                    </div>
                    <div class="">
                        <label class="control-label" ><?php echo $this->language->from_body()[12][47] ?><span class="required"> *</span></label>
                        <textarea id="present" name="current_address" class="form-control" ><?php
                            if (!empty($employee_info->current_address)) {
                                echo $employee_info->current_address;
                            }
                            ?></textarea>
                    </div>
                </div>
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <div class="">
                        ...
                        ?>" class="form-control" >
                        <input type="hidden" name="employee_experience_id" value="<?php
                        if (!empty($employee_info->employee_experience_id)) {
                            echo $employee_info->employee_experience_id;
                        }
                        ?>" class="form-control" >
                    </div>
                    <div class="">
                        ...
                        if (!empty($employee_info->position)) {
                            echo $employee_info->position;
                        }
                        ?>" class="form-control" >
                    </div>
                    <div class="">
                        ...
                        if (!empty($employee_info->job_desk)) {
                            echo $employee_info->job_desk;
                        }
                        ?>" class="form-control">
                    </div>
                    <div class="">
                        ...
                        if (!empty($employee_info->duration)) {
                            echo $employee_info->duration;
                        }
                        ?>" class="form-control">
                    </div>
                    <div class="">
                        ...
                        <textarea id="present" name="reason" class="form-control" ><?php
                            if (!empty($employee_info->reason)) {
                                echo $employee_info->reason;
                            }
                            ?></textarea>
                    </div>
                </div>
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <div class="">
                        ...
                        if (!empty($employee_info->technical)) {
                            echo $employee_info->technical;
                        }                        
                        ?>" class="form-control" >
                        <input type="hidden" name="employee_skill_id" value="<?php
                        if (!empty($employee_info->employee_skill_id)) {
                            echo $employee_info->employee_skill_id;
                        }
                        ?>" class="form-control" >
                    </div>
                    <div class="">
                        ...
                        if (!empty($employee_info->computer)) {
                            echo $employee_info->computer;
                        }
                        ?>" class="form-control" >
                    </div>
                    <div class="">
                        ...
                        if (!empty($employee_info->english)) {
                            echo $employee_info->english;
                        }
                        ?>" class="form-control">
                    </div>
                </div>
