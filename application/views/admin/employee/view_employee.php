                ...
                <div class="row">
                    ...
                    <div class="col-sm-6"><!-- ************************ Contact Details Start******************************* -->
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body form-horizontal">
                                ...
                                <?php endif; ?>
                                <?php if (!empty($employee_info->address)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Address : </label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->address"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>
                    ...
                    <div class="col-sm-6">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body form-horizontal">                                
                                ...
                                <?php endif; ?>                                
                                <?php if (!empty($employee_info->position)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" >Position :</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->position"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>                                
                                <?php if (!empty($employee_info->job_desk)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Job Desk : </label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->job_desk"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>                                
                                <?php if (!empty($employee_info->duration)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Duration : </label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->duration"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>                                
                                <?php if (!empty($employee_info->salary)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Salary : </label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->salary"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>                                
                                <?php if (!empty($employee_info->reason)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Reason Out Of Work : </label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->reason"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>
                    ...
                    <div class="col-sm-6">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body form-horizontal">                                
                                <?php if (!empty($employee_info->elementary_school)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" > Elementary School :</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->elementary_school"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>                                
                                <?php if (!empty($employee_info->junior_high_school)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" >Junior High School :</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->junior_high_school"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>                                
                                <?php if (!empty($employee_info->high_school)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">High School : </label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->high_school"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>                                
                                <?php if (!empty($employee_info->diplome)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Diplome : </label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->diplome"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>                                
                                <?php if (!empty($employee_info->university)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">University : </label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->university"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>
                    ...
                    <div class="col-sm-6">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body form-horizontal">                                
                                <?php if (!empty($employee_info->spouse_name)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" > Spouse :</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->spouse_name"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>                                
                                <?php if (!empty($employee_info->child_name)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" >Child :</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->child_name"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>                                
                                <?php if (!empty($employee_info->child2_name)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Child 2 : </label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->child2_name"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>                                
                                <div class="form-group">
                                ...
                                <?php if (!empty($employee_info->mother_name)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Mother : </label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->mother_name"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>                                
                                <?php if (!empty($employee_info->own_brosis_name)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Own Bro/Sis : </label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->own_brosis_name"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>                                
                                <?php if (!empty($employee_info->own_brosis_name1)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Own Bro/Sis 2 : </label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->own_brosis_name1"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>                                
                                <?php if (!empty($employee_info->current_address)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Current Add : </label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->current_address"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>
                   ...
                   <!-- ************************      Bank Details Start******************************* -->
                    ...
                    <div class="col-sm-6">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body form-horizontal">                                
                                <?php if (!empty($employee_info->technical)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" > Technical :</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->technical"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>                                
                                <?php if (!empty($employee_info->computer)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" >Computer :</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->computer"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>                                
                                <?php if (!empty($employee_info->english)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">English Language : </label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_info->english"; ?></p>                                                                                          
                                        </div>
                                    </div>
                                <?php endif; ?>
