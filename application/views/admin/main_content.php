        ...
        <div class="row">         
                ...
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">
                            <a href="<?php echo base_url() ?>admin/resource/resource_list/" class="info-box-text">Resource Training</a>
                        </span>
                        <span class="info-box-number"><?php
                            if (!empty($total_resource_t)) {
                                echo $total_resource_t;
                            }
                            ?></span>
                    </div>
                </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">
                            <a href="<?php echo base_url() ?>admin/resource/resource_list/" class="info-box-text">Resource Active</a>
                        </span>
                        <span class="info-box-number"><?php
                            if (!empty($total_resource_a)) {
                                echo $total_resource_a;
                            }
                            ?></span>
                    </div>
                </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">
                            <a href="<?php echo base_url() ?>admin/resource/resource_list/" class="info-box-text">Resource Deactive</a>
                        </span>
                        <span class="info-box-number"><?php
                            if (!empty($total_resource_d)) {
                                echo $total_resource_d;
                            }
                            ?></span>
                    </div>
                </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">
                            <a href="<?php echo base_url() ?>admin/employee/employee_list/" class="info-box-text">Total Employe</a>
                        </span>
                        <span class="info-box-number"><?php
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">
                            <a href="<?php echo base_url() ?>admin/resource/resource_list/" class="info-box-text">Resource Register</a>
                        </span>
                        <span class="info-box-number"><?php
                            if (!empty($total_resource_r)) {
                                echo $total_resource_r;
                            }
                            ?></span>
                    </div>
                </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">
                            <a href="<?php echo base_url() ?>admin/resource/resource_list/" class="info-box-text">Resource OJT</a>
                        </span>
                        <span class="info-box-number"><?php
                            if (!empty($total_resource_o)) {
                                echo $total_resource_o;
                            }
                            ?></span>
                    </div>
                </div>
