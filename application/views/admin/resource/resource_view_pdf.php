                    ...
                    <tr>
                                ...
                                <tr>
                                    <td style="background-color: lightgray; border-radius: 2px;">
                                        <?php if ($resource_info->photo): ?>
                                            <img src="<?php echo base_url() . $resource_info->photo; ?>" style="width: 132px; height: 138px; border-radius: 3px;" >  
                                        <?php else: ?>
                                            <img alt="resource_Image">     
                                        <?php endif; ?> 
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td>
                            <table style="width: 300px; margin-left: 10px; margin-bottom: 10px; font-size: 13px;">
                                <tr>
                                    <td colspan="2"><h2><?php echo "$resource_info->first_name " . "$resource_info->last_name"; ?></h2></td>
                                </tr>                                
                                <tr>
                                    <td style="width: 100px"><strong>resource ID : </strong></td>
                                    <td colspan="2"><?php echo "$resource_info->resourcement_id "; ?></td>
                                </tr>                                
                                <tr>
                        ...
                        <td>
                            <table style="width: 100%; font-size: 13px;">
                                <tr>
                                    ...
                                    <td style="">&nbsp; <?php echo date('d M Y', strtotime($resource_info->date_of_birth)); ?></td>
                                </tr>                            
                                <tr>
                                    <td style="text-align: right"><strong>Gender :</strong></td>

                                    <td style="width: 220px;">&nbsp; <?php echo "$resource_info->gender"; ?></td>
                                </tr>                            
                                <tr>
                                    <td style="text-align: right;"><strong>Maratial Status :</strong></td>

                                    <td style="width: 220px;">&nbsp; <?php echo "$resource_info->maratial_status"; ?></td>
                                </tr>
                                <tr>
                                    <td style="text-align: right;"><strong>Father's Name :</strong></td>

                                    <td style="width: 220px;">&nbsp; <?php echo "$resource_info->father_name"; ?></td>
                                </tr>                                
                            </table>
                        </td>
                    </tr>
                        ...
                        <td>
                            <table style="font-size: 13px;width: 100%">
                                <tr>
                                    ...
                                    <td style="">&nbsp; <?php echo $resource_info->bank_name; ?></td>
                                </tr>                            
                                <tr>
                                    <td style="text-align: right"><strong>Branch Name :</strong></td>

                                    <td>&nbsp;<?php echo "$resource_info->branch_name"; ?></td>
                                </tr>                            
                                <tr>
                                    <td style="text-align: right"><strong>Account Name :</strong></td>

                                    <td>&nbsp;<?php echo "$resource_info->account_name"; ?></td>
                                </tr>                                
                                <tr>
                                    <td style="text-align: right"><strong>Account Number :</strong></td>

                                    <td>&nbsp;<?php echo "$resource_info->account_number"; ?></td>
                                </tr>                            
                            </table>
                        </td>
                    </tr>
