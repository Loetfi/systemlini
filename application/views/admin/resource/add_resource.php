...
<form role="form" id="resource-form" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/resource/save_resource/<?php
if (!empty($resource_info->resource_id)) {
    echo $resource_info->resource_id;
}
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        if (!empty($resource_info->id_proff_path)) {
                            echo $resource_info->id_proff_path;
                        }
                        ?>">
                        <div class="col-sm-8">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <?php if (!empty($resource_info->id_proff)): ?>
                                    <span class="btn btn-default btn-file"><span class="fileinput-new" style="display: none" >Select file</span>
                                        <span class="fileinput-exists" style="display: block">Change</span>
                                        <input type="hidden" name="id_proff" value="<?php echo $resource_info->id_proff ?>">
                    ...
                    <div class="form-group">
                        ...
                        if (!empty($resource_info->other_document_path)) {
                            echo $resource_info->other_document_path;
                        }
                        ?>">
                        <div class="col-sm-8">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <?php if (!empty($resource_info->other_document)): ?>
                                    <span class="btn btn-default btn-file"><span class="fileinput-new" style="display: none" >Select file</span>
                                        <span class="fileinput-exists" style="display: block">Change</span>
                                        <input type="hidden" name="other_document" value="<?php echo $resource_info->other_document ?>">
                                        <input type="file" name="other_document" >
                                    </span>                                    
                                    <span class="fileinput-filename"> <?php echo $resource_info->other_document_filename ?></span>                                          
                                <?php else: ?>
                                    <span class="btn btn-default btn-file"><span class="fileinput-new" >Select file</span>
                                        <span class="fileinput-exists" >Change</span>                                            
                                        <input type="file" name="other_document" >
                    ...
                    <?php if (!empty($resource_info->status)) : ?>
                        <div class="">
                            ...
                            <select name="status" class="form-control">
                                ...
                                <option value="3" 
                                <?php
                                echo $resource_info->status == '3' ? 'selected' : '';
