        ...
        <div class="wrap-fpanel">
            <div class="panel panel-default" data-collapsed="0">
                ...
                <div class="panel-body">
                    <form id="form" action="<?php echo base_url() ?>admin/resource/save_resource_award/<?php
                    if (!empty($award_info->resource_award_id)) {
                        echo $award_info->resource_award_id;
                    }
                    ?>" method="post"  enctype="multipart/form-data" class="form-horizontal">
                        <div class="panel_controls">
                            <div class="form-group" id="border-none">
                                ...
                                <div class="col-sm-5">
                                    <select name="designations_id" class="form-control" onchange="get_resource_by_designations_id(this.value)">                            
                            ...
                            <div class="form-group" id="border-none">
                                ...
                                <div class="col-sm-5">
                                    <select name="resource_id" id="resource" class="form-control" >
                                        <option value="">Select resource...</option>  
                                        <?php if (!empty($resource_info)): ?>
                                            <?php foreach ($resource_info as $v_resource) : ?>
                                                <option value="<?php echo $v_resource->resource_id; ?>" 
                                                <?php
                                                if (!empty($award_info->resource_id)) {
                                                    echo $v_resource->resource_id == $award_info->resource_id ? 'selected' : '';
                                                }
                                                ?>><?php echo $v_resource->first_name . ' ' . $v_resource->last_name ?></option>                            
                                                    <?php endforeach; ?>
                                                <?php endif; ?>
                                    </select>
                                </div>
    ...
    <div class="col-sm-12" data-offset="0">
        <div class="panel panel-default">
            ...
            <table class="table table-bordered table-hover" id="dataTables-example">
                ...
                <tbody>
                    <?php if (!empty($all_resource_award_info)):foreach ($all_resource_award_info as $v_award_info): ?>
                            <tr>
                                <td><?php echo $v_award_info->resourcement_id ?></td>
                                ...
                                <td>
                                    <?php echo btn_edit('admin/resource/resource_award/' . $v_award_info->resource_award_id . '/' . $v_award_info->designations_id); ?>
                                    <?php echo btn_delete('admin/resource/delete_resource_award/' . $v_award_info->resource_award_id); ?>
                                </td>
                            </tr>                   
                        <?php endforeach; ?>
                    <?php endif; ?>
