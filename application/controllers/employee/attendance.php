...
class Attendance extends Employee_Controller {
    ...
    public function manage_attendance() {
        ...
        $data['employee_info'] = $this->attendance_model->get_employee_id_by_dept_id_yanglogin($data['department_id'],$this->session->userdata('employee_id'));
        ...
        $data['subview'] = $this->load->view('employee/attendance/manage_attendance', $data, TRUE);
    ...
    public function save_attendance() {
        ...
        redirect('employee/attendance/manage_attendance'); //redirect page
    }
    ...
    public function attendance_report() {
        ...
        $this->attendance_model->_order_by = "department_id";
        $data['all_department'] = $this->attendance_model->get();
        $data['subview'] = $this->load->view('employee/attendance/attendance_report', $data, TRUE);
        $this->load->view('employee/_layout_main', $data);
    }
    ...
    public function create_pdf($department_id, $date) {
        ...
        $view_file = $this->load->view('employee/attendance/Emp_report_pdf', $data, true);
