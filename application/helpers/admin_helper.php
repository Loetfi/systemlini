...
function btn_viewtraining($uri) {
    return anchor($uri, '<span class="fa fa-file-text"></span>', array('class' => "btn btn-info btn-xs",'data-toggle'=>'tooltip', 'data-placement'=>'top', 'title'=>'View Training'));
}
