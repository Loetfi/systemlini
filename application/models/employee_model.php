...
class Employee_Model extends MY_Model {
    ...
    public function all_emplyee_info($id = NULL) {
        ...
        $this->db->select('tbl_employee_education.*', FALSE);
        $this->db->select('tbl_employee_family.*', FALSE);
        $this->db->select('tbl_employee_experience.*', FALSE);
        $this->db->select('tbl_employee_skill.*', FALSE);
        ...
        $this->db->join('tbl_employee_education', 'tbl_employee_education.employee_id = tbl_employee.employee_id', 'left');
        $this->db->join('tbl_employee_family', 'tbl_employee_family.employee_id = tbl_employee.employee_id', 'left');
        $this->db->join('tbl_employee_experience', 'tbl_employee_experience.employee_id = tbl_employee.employee_id', 'left');
        $this->db->join('tbl_employee_skill', 'tbl_employee_skill.employee_id = tbl_employee.employee_id', 'left');
