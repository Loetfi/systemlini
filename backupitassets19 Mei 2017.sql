...
insert  into `tbl_attendance`(`attendance_id`,`employee_id`,`leave_category_id`,`date`,`attendance_status`) values (1,2,NULL,'2017-05-25',1),(2,4,NULL,'2017-05-25',1),(3,4,NULL,'2017-05-26',1),(4,4,NULL,'2017-05-27',1);
...
insert  into `tbl_employee_bank`(`employee_bank_id`,`employee_id`,`bank_name`,`branch_name`,`account_name`,`account_number`) values (3,4,'Mandiri','-----','-----','000000000'),(4,5,'Mandiri','-','-','-'),(5,6,'BCA','Wisma Mulia','chandrayuventus','1010101010'),(6,7,'Muamalat','Jakarta','Resfeb0001','1121212121212');
...
insert  into `tbl_employee_document`(`document_id`,`employee_id`,`resume`,`resume_path`,`resume_filename`,`offer_letter`,`offer_letter_filename`,`offer_letter_path`,`joining_letter`,`joining_letter_filename`,`joining_letter_path`,`contract_paper`,`contract_paper_filename`,`contract_paper_path`,`id_proff`,`id_proff_filename`,`id_proff_path`,`other_document`,`other_document_filename`,`other_document_path`) values (3,4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,6,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(6,7,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
insert  into `tbl_employee_education`(`employee_education_id`,`employee_id`,`elementary_school`,`junior_high_school`,`high_school`,`diplome`,`university`) values (3,4,'Mandiri','-----','-----','000000000',''),(4,5,'Mandiri','-','-','-',''),(5,6,'BCA','Wisma Mulia','chandrayuventus','1010101010',''),(6,7,'SDN Jagakarsa3','SMP Jagakarsa1','SMA Jagakarsa2','BSI','Mandala Satria Univ');
