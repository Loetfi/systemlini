...
insert  into `tbl_application_list`(`application_list_id`,`employee_id`,`leave_category_id`,`reason`,`leave_start_date`,`leave_end_date`,`application_status`,`view_status`,`notify_me`,`application_date`) values (1,6,17,'Go to Sumatra','2017-05-30','2017-06-08',1,1,1,'2017-05-26 18:53:02');
...
insert  into `tbl_designations`(`designations_id`,`department_id`,`designations`) values (1,1,'IT Department'),(2,2,'Project Admin'),(3,2,'Project Control'),(4,2,'Project Manager'),(5,3,'Marketing Project'),(6,2,'Production Planning Inventory Control'),(7,4,'Accounting'),(8,5,'HRD Personal'),(9,5,'General Affair'),(10,1,'IT Engineer');
...
insert  into `tbl_employee_bank`(`employee_bank_id`,`employee_id`,`bank_name`,`branch_name`,`account_name`,`account_number`) values (3,4,'Mandiri','-----','-----','000000000'),(4,5,'Mandiri','-','-','-'),(5,6,'BCA','Wisma Mulia','chandrayuventus','1010101010'),(6,7,'Muamalat','Jakarta','Resfeb0001','1121212121212'),(7,8,'-','-','-','-');
...
insert  into `tbl_employee_document`(`document_id`,`employee_id`,`resume`,`resume_path`,`resume_filename`,`offer_letter`,`offer_letter_filename`,`offer_letter_path`,`joining_letter`,`joining_letter_filename`,`joining_letter_path`,`contract_paper`,`contract_paper_filename`,`contract_paper_path`,`id_proff`,`id_proff_filename`,`id_proff_path`,`other_document`,`other_document_filename`,`other_document_path`) values (3,4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,6,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(6,7,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(7,8,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
insert  into `tbl_employee_education`(`employee_education_id`,`employee_id`,`elementary_school`,`junior_high_school`,`high_school`,`diplome`,`university`) values (3,4,'Mandiri','-----','-----','000000000',''),(4,5,'SDN CAKUNG','-','-','-','-'),(5,6,'SD Bekasi Utara','SMP Bekasi Utara','SMA Bekasi Barat','-','Bhayangkara'),(6,7,'SDN Jagakarsa3','SMP Jagakarsa1','SMA Jagakarsa2','BSI','Mandala Satria Univ'),(7,8,'-','-','-','-','-');
...
insert  into `tbl_employee_experience`(`employee_experience_id`,`employee_id`,`company_name`,`position`,`job_desk`,`duration`,`salary`,`reason`) values (23,6,'Koperasi Telkomsel','Staff Admin','4 Year','2500000','0','Test'),(24,5,'-','-','-','-','0','-'),(25,4,'-','-','-','-','0','-'),(26,7,'-','-','-','-','0','-'),(27,8,'-','-','-','-','0','-');
...
insert  into `tbl_employee_family`(`employee_family_id`,`employee_id`,`spouse_name`,`child_name`,`child2_name`,`mother_name`,`own_brosis_name`,`own_brosis_name1`,`current_address`) values (1,6,'Lidya Bakara','-','-','TS Mardiana','Andi','Yusuf','test'),(22,5,'-','-','-','-','-','-','-'),(23,4,'-','-','-','-','-','-','-'),(24,7,'-','-','-','-','-','-','-'),(25,8,'-','-','-','-','-','-','-');
...
insert  into `tbl_employee_payroll`(`payroll_id`,`employee_id`,`basic_salary`,`house_rent_allowance`,`medical_allowance`,`special_allowance`,`fuel_allowance`,`phone_bill_allowance`,`other_allowance`,`tax_deduction`,`provident_fund`,`other_deduction`,`employment_type`) values (1,4,2500000,'100000','100000','100000','100000','100000','100000','25000','50000','50000',1),(2,6,6650000,'100000','100000','100000','100000','100000','100000','65000','50000','50000',2);
...
insert  into `tbl_employee_skill`(`employee_skill_id`,`employee_id`,`technical`,`computer`,`english`) values (27,5,'-','MS, Office, Database','English'),(28,6,'Instalastion PC and Software','Ms Office, Microsof, Php, MySql, Database','English'),(29,4,'-','-','-'),(30,8,'-','MS, Office, Database','English');
...
insert  into `tbl_gsettings`(`id_gsettings`,`name`,`logo`,`full_path`,`email`,`address`,`city`,`country_id`,`active_language`,`phone`,`mobile`,`hotline`,`fax`,`website`,`currency`) values (1,'PT Lima Inti Sinergi','img/uploads/LINII1.png','C:/xampp/htdocs/dbhrd/img/uploads/LINII1.png','admin@admin.com','Jl. Palbatu 5 No 8 Menteng Dalam Jak-Sel','Jakarta',101,'English','','01723611125','','','http://hrms.limaintisinergi.com','0');
...
insert  into `tbl_salary_payment`(`salary_payment_id`,`employee_id`,`basic_salary`,`house_rent_allowance`,`medical_allowance`,`special_allowance`,`fuel_allowance`,`phone_bill_allowance`,`other_allowance`,`tax_deduction`,`provident_fund`,`other_deduction`,`payment_for_month`,`award_amount`,`fine_deduction`,`payment_type`,`comments`,`payment_date`) values (1,4,2500000,'100000','100000','100000','100000','100000','100000','25000','50000','50000','2017-05',0,'','','','2017-05-26 01:38:06'),(2,6,6650000,'100000','100000','100000','100000','100000','100000','65000','50000','50000','2017-01',0,'','','','2017-05-26 01:53:52'),(3,6,6650000,'100000','100000','100000','100000','100000','100000','65000','50000','50000','2017-02',0,'','','','2017-05-26 01:54:03'),(4,6,6650000,'100000','100000','100000','100000','100000','100000','65000','50000','50000','2017-03',0,'','','','2017-05-26 01:54:19'),(5,6,6650000,'100000','100000','100000','100000','100000','100000','65000','50000','50000','2017-04',0,'','','','2017-05-26 01:54:36'),(6,6,6650000,'100000','100000','100000','100000','100000','100000','65000','50000','50000','2017-05',0,'','','','2017-05-26 01:54:54');
...
insert  into `tbl_salary_payslip`(`payslip_id`,`payslip_number`,`salary_payment_id`,`payslip_generate_date`) values (1,'2017051',1,'2017-05-26 01:44:32'),(2,'2017052',2,'2017-05-26 01:55:07'),(3,'2017053',6,'2017-05-26 02:01:35');
...
insert  into `tbl_user`(`user_id`,`first_name`,`last_name`,`user_name`,`password`,`flag`) values (1,'Root','Administrator','admin','55677fc54be3b674770b697114ce0730300da0f6783202e2d17d7191ba68ec97cab4b61d3470f298d0ca2435111c29b8d5ad63058b725916336fdab9584829f4',0);
