...
insert  into `tbl_gsettings`(`id_gsettings`,`name`,`logo`,`full_path`,`email`,`address`,`city`,`country_id`,`active_language`,`phone`,`mobile`,`hotline`,`fax`,`website`,`currency`) values (1,'PT Lima Inti Sinergi','img/uploads/LINII1.png','C:/xampp/htdocs/dbhrd/img/uploads/LINII1.png','admin@admin.com','Epicentrum South Walk 529A\r\nJL. HR. Rasuna Said','Jakarta',101,'English','','01723611125','','','http://hrms.limaintisinergi.com','0');
...
insert  into `tbl_resource_skill`(`resource_skill_id`,`resource_id`,`technical`,`computer`,`english`) values (31,19,'-','-','-');
